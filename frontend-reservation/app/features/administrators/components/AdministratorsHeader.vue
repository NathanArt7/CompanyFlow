...
<template>
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      <h1 class="text-foreground text-2xl md:text-3xl font-bold">Administrateurs</h1>
      <p class="text-muted text-sm mt-1">Gérez les comptes administrateurs de votre entreprise.</p>
    </div>
